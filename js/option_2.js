      ...
      emails: [
        {
          ...
          options: [
            {
              text: "Stay at work, finish the project, impress boss",
              wife: 0,
              work: 15,
            },
            {
              text: "Leave work early, buy flowers, go home",
              wife: 10,
              work: 0,
            },
            {
              text: "Bring laptop home, try to balance both",
              wife: 5,
              work: 5,
            },
          ],
      ...
      emails: [
        {
          ...
          options: [
            {
              text: "Listen to wife and change presentation",
              wife: 10,
              work: 10,
            },
            { text: "Ignore wife and go with your own idea", wife: 0, work: 0 },
            {
              text: "Tell wife it's great but stay silent at work",
              wife: 5,
              work: 0,
            },
          ],
...
[3 comments] [12 likes]`,
          ...
          options: [
            {
              text: "Lash out at coworkers now, comfort her later",
              wife: 10,
              work: 0,
            },
            {
              text: "Ask her to delete post and confront her",
              wife: 0,
              work: 5,
            },
...
anyway. do whatever you want today. i'm done getting my hopes up.`,
          ...
          options: [
            ...
            {
              text: "Leave early, buy something meaningful",
              wife: 10,
              work: 0,
            },
            {
              text: "Send flowers to her workplace + plan late surprise",
              wife: 5,
              work: 10,
            },
          ],
...
function getCurrentDayDecisionEmail() {
  const dayData = storyData.days[gameState.currentDay - 1];
...
function renderInbox() {
  ...
  emails.forEach((email) => {
    ...
    emailItem.className = `email-item ${isUnread ? "unread" : ""} ${isSelected ? "selected" : ""} ${email.mystery ? "mystery" : ""}`;
...
function renderEmailView(email) {
  ...
  // Show decision modal for decision emails that haven't been decided
  if (email.isDecision && !hasDecided) {
...
function restartGame() {
  ...
  document.getElementById("dayIndicator").textContent = "DAY 1 OF 5";
  ...
  document.getElementById("emailContent").innerHTML =
    '<div class="no-email-selected">Select an email to read</div>';

  renderInbox();

  // Show Day 1 transition
  setTimeout(() => {
    showDayTransition(1);
  }, 500);
}
